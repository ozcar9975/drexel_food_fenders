...
var name4 = object_get_name(obj_tower4_power)
var name5 = object_get_name(obj_tower5_power)
var name6 = object_get_name(obj_tower1_powerpoint)
var name7 = object_get_name(obj_tower2_powerpoint)
var name8 = object_get_name(obj_tower3_powerpoint)
var name9 = object_get_name(obj_tower4_powerpoint)
var name10 = object_get_name(obj_tower5_powerpoint)
...
global.inventory.item_add(name4,100,spr_tower4_power)
global.inventory.item_add(name5,100,spr_tower5_power)
global.inventory.item_add(name6,100,spr_tower1_powerpoint)
global.inventory.item_add(name7,100,spr_tower2_powerpoint)
global.inventory.item_add(name8,100,spr_tower3_powerpoint)
global.inventory.item_add(name9,100,spr_tower4_powerpoint)
global.inventory.item_add(name10,100,spr_tower5_powerpoint)
